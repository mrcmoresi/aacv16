...
def my_kernel(X, Y):
    return distance.cdist(X, Y, metric=intersection_kernel)
    ...
    for i in range(fold):
        ...
        for C in list_C:
            for gamma in list_gamma:
                ...
                svm = SVC(C=C, gamma=gamma, kernel=my_kernel, verbose=1)
