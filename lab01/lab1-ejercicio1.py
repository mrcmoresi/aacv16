...
if __name__ == "__main__":
    ...
    #params_C = {1 : [], 3 : [],5 : [],7 : [],9 : [],10 : []}
    #params_C = {0.1 : [], 1 : [], 2 : []}
    params_C = {0.5 : [], 1 : [], 1.5: [], 2: []}
    ...
    for i in range(fold):
        ...
        for fname, cid in train_set:
            # cargo los bovw de cada imagen del train set
            bovwfile = join(output_path, splitext(fname)[0] + '.bovw')
    ...
    # print('params_C iter n° {} -- {}', format(i, params_C))
    # print('fold n°:{} -- sdev = {} -- media = {}', format(i,sdev,media))
